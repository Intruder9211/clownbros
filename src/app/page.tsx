            ...
            <section className="hero-section" id="hero" style={{ paddingTop: '160px', paddingBottom: '96px' }}>
                <div className="container">
                    <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '64px', alignItems: 'center', marginBottom: '80px' }}>
                        ...
                        <div className="reveal-right visible float-element" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '520px', position: 'relative' }}>
                    ...
                    <div className="scroll-reveal editorial-card" style={{ backgroundColor: 'var(--dark-section)', border: '1px solid var(--border-color)', borderRadius: 'var(--radius-card)', display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '48px', alignItems: 'center', padding: '64px', overflow: 'hidden', position: 'relative' }}>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                            <span className="section-tagline" style={{ color: 'var(--primary)', marginBottom: '0px' }}>Agency Philosophy</span>
                            <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '38px', fontWeight: 500, color: '#FFFFFF', lineHeight: 1.35, margin: 0 }}>
                        ...
                        <div className="float-element" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '360px', position: 'relative' }}>
